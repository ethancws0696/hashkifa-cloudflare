...
import PurchaseInfo from "../components/user/purchaseInfo/purchaseInfo";
    ...
    <>
      ...
      <style jsx global>{`
        ...
        *,
        ...
        .ttl-card::before {
          content: "";
          background: url(../../public/images/card.svg) no-repeat;
        ...
        .video-container .title-view h1::after {
          content: "";
          width: 78px;
          background: #ff9016;
          height: 5px;
        ...
        .cover-main {
          background: url(../../public/images/cover-checkout.png) no-repeat;
          height: 365px;
          display: -webkit-box;
          display: -ms-flexbox;
          display: flex;
        ...
        .rdt_TableHead .rdt_TableHeadRow .rdt_TableCol:first-child {
          min-width: 281px;
        }
        ...
        .table-responsive .rdt_TableHead .rdt_TableHeadRow {
        ...
        // .rdt_TableRow, .rdt_TableHeadRow { border: 0; }
        ...
        .rdt_TableBody .rdt_TableRow:hover .rdt_TableCell {
          color: #fff;
        }
        .card .rdt_Table,
        .card .rdt_Table {
        ...
        .rdt_TableHead .rdt_TableHeadRow .rdt_TableCol:nth-child(2) {
          min-width: 210px;
        }
        ...
        .rdt_TableHead .rdt_TableHeadRow .rdt_TableCol:nth-child(3) {
          max-width: 120px;
        }
        ...
        .card #pagination-first-page:disabled,
        .card #pagination-previous-page:disabled,
        .card #pagination-next-page:disabled,
        .card #pagination-last-page:disabled,
        .card #pagination-first-page,
        .card #pagination-previous-page,
        .card #pagination-next-page,
        .card #pagination-last-page {
          fill: #fff !important;
          color: #fff !important;
        }
        .card nav select {
        ...
        .user-purchase-chart table tbody tr:hover td {
          color: #fff;
        }
        .user-purchase-chart table tbody tr:hover td .ttl-price {
          color: #fff;
        }
