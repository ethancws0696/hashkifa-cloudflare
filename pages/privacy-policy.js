            ...
            <div className="row">
              <div className="col-12">
                <div className="mb-4">
                  ...
                  <span className="mb-2">Last updated: March 10, 2022 </span>
                  <p>
                ...
                <div className="mb-4">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Website </strong> refers to Hashkifa, accessible
                      from{" "}
                      <a
                        className=""
                        href="https://www.hashkifa.com/"
                        target="_blank"
                      >
                        https://www.hashkifa.com/
                      </a>
                    </li>
                    <li>
                ...
                <div className="mb-4">
                  ...
                  <h2 className="mb-2">Types of Data Collected </h2>
                ...
                <div className="mb-4">
                  <h2 className="mb-2">Use of Your Personal Data </h2>
                  <p>
                ...
                <div className="mb-4">
                  <h2 className="mb-2">Retention of Your Personal Data</h2>
                  <p>
                ...
                <div className="mb-4">
                  <h2 className="mb-2">Transfer of Your Personal Data</h2>
                  <p>
                ...
                <div className="mb-4">
                  <h1 className="mb-3">Children's Privacy</h1>
                  <p>
                ...
                <div className="mb-4">
                  <h1 className="mb-3">Links to Other Websites </h1>
                  <p>
                ...
                <div className="mb-4">
                  <h1 className="mb-3">Changes to this Privacy Policy </h1>
                  <p>
                ...
                <div className="mb-4">
                  ...
                  <ul>
                    <li>
                      <p>By email: info@hashkifa.com</p>
                    </li>
                    <li>
                      <p>
                        By visiting this page on our website:{" "}
                        <a
                          href="https://www.hashkifa.com/contact"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://www.hashkifa.com/contact
                        </a>
                      </p>
                    </li>
                  </ul>
